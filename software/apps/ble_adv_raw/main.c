...
int main(void) {
  ...
  uint8_t ble_data[BLE_GAP_ADV_SET_DATA_SIZE_MAX] = {
      0x02, 0x01, 0x06, /* Structure 1 */ 
      /* 0x0A, 0x09, 0x43, 0x53, 0x33, 0x39, 0x37, 0x2F, 0x34, 0x39, 0x37, --- Old name = CS397/497 */  
      0x09 /* Length */, 0x09 /* Type=name ("SGDevice") */, 0x53, 0x47, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, /* Structure 2 */
      0x3 /* Length */, 0xFF /* Type=manufacturer (Nordic) */, 0x00, 0x59 /* Structure 3 */ 
  };
